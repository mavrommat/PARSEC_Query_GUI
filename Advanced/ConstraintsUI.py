...
class Ui_Constraints(object):
    def setupUi(self, Constraints):
        ...
        self.left_contrain = QLineEdit(self.groupBox)
        self.left_contrain.setObjectName(u"left_contrain")

        self.gridLayout_6.addWidget(self.left_contrain, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Constraints):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("Constraints", u">", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("Constraints", u"<", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("Constraints", u">=", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("Constraints", u"<=", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("Constraints", u"<=>", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("Constraints", u"=!", None))
